                        ...
                        <div class="col-md-12">
                            ...
                            <div class="d-flex flex-column gap-2">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="mx-2">:</span>
                                    <input type="text" class="form-control col" value="{{ $invData->invoice_date }}" readonly>
                                </div>
                                <div class="d-flex align-items-center">
                            ...
                            @else
                                @foreach ($poItemData as $row)
                                    <tr>
                                        ...
                                        <td>{{ $row->size }}</td>
                                        <td>{{ $row->qty_total }}</td>
                                        <td>{{ $row->qty_arrived }}</td>
                                        <td>{{ $row->stock_id ? $row->poToSto->item_type : $row->poToEq->eq_type }}</td>
