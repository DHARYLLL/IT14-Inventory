            ...
            <div class="card-body h-100">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="embalmName" placeholder="Embalmer name" value="{{ old('embalmName') ? old('embalmName') : $leData->embalmer_name }}" readonly>
                        @error('embalmName')
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" class="form-control" name="embalmPrice" placeholder="Price" value="{{ old('embalmPrice') ? old('embalmPrice') : $leData->prep_price }}" readonly>
                        @error('embalmPrice')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                                            ...
                                            <div class="col-md-12 mb-1">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="number" class="form-control" name="qty[]" value="{{ old('qty.'.$loop->index, $row->stock_used) }}" readonly>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="number" class="form-control" name="qtySet[]" value="{{ old('qtySet.'.$loop->index, $row->stock_used_set) }}" readonly>
                                        ...
                                        <div class="row mt-2 cust-white-bg mx-1">
                                            ...
                                            <div class="col-md-12 mb-1">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="form-label fw-semibold text-secondary">Qty.</label>
                                                        <input type="number" class="form-control" name="eqQty[]" value="{{ old('eqQty.'.$loop->index, $row->eq_used) }}" readonly>
                                                    ...
                                                    <div class="col-md-4">
                                                        <label class="form-label fw-semibold text-secondary">Pcs/Kg/L</label>
                                                        <input type="number" class="form-control" name="eqQtySet[]" value="{{ old('eqQtySet.'.$loop->index, $row->eq_used_set) }}" readonly>
