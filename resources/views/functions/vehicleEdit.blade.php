                    ...
                    <div class="col-md-12 cust-h">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="brand" value="{{ old('brand', $vehData->veh_brand) }}">
                                @error('brand')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="plateNo" value="{{ old('plateNo', $vehData->veh_plate_no) }}">
                                @error('plateNo')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
