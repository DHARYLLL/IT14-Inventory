...
<div class="d-flex align-items-center justify-content-end p-2 mb-2">
    <a href="{{ route('Service-Request.index') }}" class="btn btn-outline-success d-flex align-items-center gap-2">
...
<div class="bg-white rounded border shadow-sm p-4">
    <form action="{{ route('Service-Request.store') }}" method="post" class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="clientName" id="clientName" class="form-control" placeholder="Enter Full Name"
                ...
                @foreach ($oldEq as $i => $item)
                    <div class="row g-2 align-items-end mb-2 added-item">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="eqName[]" value="{{ $item }}"
                                readonly>
        ...
        <div class="text-end mt-4">
            <button type="submit" class="btn btn-green submit-btn"><i class="bi bi-send"></i>
                Submit Request
            </button>
        </div>
