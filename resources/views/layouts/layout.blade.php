...
<head>
    ...
    <!-- Custom JS -->
    <script defer src="{{ mix('js/func.js') }}"></script>
    ...
    <link rel="stylesheet" href="{{ mix('css/purchaseOrder.css') }}">
    <link rel="stylesheet" href="{{ mix('css/layout.css') }}">
    <link rel="stylesheet" href="{{ mix('css/equipment.css') }}">
    <link rel="stylesheet" href="{{ mix('css/supplier.css') }}">
    <link rel="stylesheet" href="{{ mix('css/stockEdit.css') }}">
