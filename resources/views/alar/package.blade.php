...
<div class="d-flex align-items-center gap-3 justify-content-between p-2 mb-2" style="height: 10%;">
    <div class="input-group w-25" style="border-radius: 10px; overflow: hidden;">
