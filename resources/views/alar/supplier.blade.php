                                ...
                                <div class="modal-header modal-header-custom gap-3">
                                    <div>
                                        <img src="{{ asset('images/alar-logo.png') }}" alt="Alar Memorial Services Logo"
                                            style="max-width: 100%; height: 3rem; border-radius: 8px">
                                    </div>

                                    <h1 class="modal-title fs-5" id="EditSupplierModalLabel{{ $supplier->id }}">Edit
                                        Supplier</h1>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <label for="" class="fomr-label">
                                                    <i class="bi bi-geo-alt" style="color: #60BF4F"></i> Company
                                                    Address
                                                </label>
