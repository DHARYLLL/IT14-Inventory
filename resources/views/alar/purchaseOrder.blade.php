...
<div class="d-flex align-items-center justify-content-between m-1">
    ...
    <a href="{{ route('Purchase-Order.create') }}" class="btn btn-custom d-flex align-items-center gap-2"><i
